...
class Block(commands.Cog):
  ...
  async def add_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:ztick:1448951767990796298> User Blacklisted",
  ...
  async def remove_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:zcross:1448951756372443296> User Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:ztick:1448951767990796298> User Unblacklisted",
  ...
  async def show_users(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:zcross:1448951756372443296> No Blacklisted Users",
  ...
  async def add_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          title="<:zcross:1448951756372443296> Guild Already Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:ztick:1448951767990796298> Guild Blacklisted",
  ...
  async def remove_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:zcross:1448951756372443296> Guild Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:ztick:1448951767990796298> Guild Unblacklisted",
  ...
  async def show_guilds(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:zcross:1448951756372443296> No Blacklisted Guilds",
