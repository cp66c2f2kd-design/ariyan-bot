    ...
    async def messages(self, ctx, member: discord.Member = None):
        ...
        embed = discord.Embed(
            description=(
                ...
                f"**<a:ArrowRed:1448951520077811806>Upgrade Your Experience With [Zyrox Noprefix](https://discord.gg/PkDre8Juhp)**"
            ),
            color=0x87CEEB
        )
        embed.set_author(name=f"Requested by {ctx.author}", icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
