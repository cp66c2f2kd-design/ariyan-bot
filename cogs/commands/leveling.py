...
└─────────────────────────────────────────┘
    ...
    async def rewards_list (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="Level Rewards",color =0x87CEEB ,timestamp =datetime .now (timezone .utc ))
    ...
    async def multiplier_list (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="XP Multipliers",color =0x87CEEB ,timestamp =datetime .now (timezone .utc ))
    ...
    async def blacklist_list (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="Leveling Blacklist",color =0x87CEEB ,timestamp =datetime .now (timezone .utc ))
    ...
    async def list_level_roles (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="Level Roles",color =0x87CEEB ,timestamp =datetime .now (timezone .utc ))
