...
class Embed(commands.Cog):
    ...
    async def _embed(self, ctx):
        ...
        button_send = Button(label="Send Embed",  emoji="<:ztick:1448951767990796298>", style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji="<:zcross:1448951756372443296>", style=discord.ButtonStyle.danger)
