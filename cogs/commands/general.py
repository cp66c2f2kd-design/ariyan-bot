...
class General(commands.Cog):
  ...
  async def poll(self, ctx: commands.Context, *, message):
    ...
    await msg.add_reaction("<:ztick:1448951767990796298>")
  ...
  async def invite(self, ctx: commands.Context):
      embed = discord.Embed(
          title="<:zyroxconnection:1448949425828528230> Ariyan Integration Hub!",
      ...
      embed.add_field(
          ...
          value=(
              ">>> **[Invite Ariyan](https://discord.com/oauth2/authorize?client_id=1498197753774473308&permissions=8&integration_type=0&scope=bot+applications.commands)**\n"
              "**[Support Server](https://discord.gg/PkDre8Juhp)**"
          ),
          inline=False
      )
      embed.set_footer(
          text=f"Powered by Ariyan",
