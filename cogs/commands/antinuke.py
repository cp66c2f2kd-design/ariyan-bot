...
class Antinuke(commands.Cog):
  ...
  async def antinuke(self, ctx, option: str = None):
    ...
    if option is None:
      embed = discord.Embed(
        title='<:zSafe:1448951403434479626> Ariyan Security',
      ...
      embed.set_footer(text="Ariyan Your 24/7 Security Partner.", icon_url=self.bot.user.avatar.url)
      ...
      if is_activated:
        ...
        setup_embed.description += "\n<:ztick:1448951767990796298> Checking Ariyan's role position for optimal configuration..."
        await setup_message.edit(embed=setup_embed)

        await asyncio.sleep(1)
        setup_embed.description += "\n<:ztick:1448951767990796298> | Crafting and configuring the Ariyan Supreme role..."
        await setup_message.edit(embed=setup_embed)
        ...
        await asyncio.sleep(1)
        setup_embed.description += "\n<:ztick:1448951767990796298>| Ensuring precise placement of the Ariyan Supreme™ role..."
        await setup_message.edit(embed=setup_embed)
        try:
        ...
        embed.set_footer(text="Successfully Enabled Antinuke for this server | Powered by Ariyan", icon_url=self.bot.user.avatar.url)
        embed.set_thumbnail(url=self.bot.user.avatar.url)
