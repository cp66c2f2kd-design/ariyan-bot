...
class MentionDropdown(discord.ui.Select):
    def __init__(self, message: discord.Message, bot: commands.Bot, prefix: str):
        ...
        super().__init__(placeholder="Start With Ariyan X", min_values=1, max_values=1, options=options)

    async def callback(self, interaction: discord.Interaction):
        if interaction.user.id != self.message.author.id:
            return await interaction.response.send_message("This menu is not for you!", ephemeral=True)

        embed = discord.Embed(color=0x87CEEB)  # Red
        ...
        if self.values[0] == "Home":
            ...
            embed.description = (
                ...
                f"💗 Cute as a Girl, Smart as AI\n\n"
                f"🛡️ Ariyan protects your server silently… but completely.\n"
                f"From raids to nukes, I'll keep everything safe — bas mere paas raho 💕\n\n"
                f"⚙️ **Features:** Anti-Nuke • AutoMod • Logging • Tickets • Music • AI Chat\n\n"
                f"💬 **Support:** [Join Server](https://discord.gg/PkDre8Juhp)\n"
                f"🤖 **Invite:** [Add Ariyan](https://discord.com/oauth2/authorize?client_id=1498197753774473308&permissions=8&scope=bot+applications.commands)\n\n"
            ...
            embed.description = (
                ...
                "**The Founder**\n"
                "**[01]. [Ariyan](https://discord.com/users/1383672814820655215)**"
            )
        elif self.values[0] == "Links":
            embed.title = "<:zyroxlinks:1448949436939239495> Important Links"
            embed.description = (
                "**[Invite Ariyan](https://discord.com/oauth2/authorize?client_id=1498197753774473308)**\n"
                "**[Join Support Server](https://discord.gg/PkDre8Juhp)**"
            )

        embed.set_footer(text="Powered by Ariyan", icon_url=self.bot.user.avatar.url)
...
class Mention(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.color = 0x87CEEB  # Full red
        self.bot_name = "Ariyan"
