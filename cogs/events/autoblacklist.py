        ...
        try:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                if guild_id:
                    ...
                    if channel:
                        embed = discord.Embed(
                            title="<:zwarning:1448949627712966717> Guild Blacklisted",
                            description=(
                                f"This guild has been blacklisted due to spamming or automation. "
                                f"If you believe this is a mistake, please contact our [Support Server](https://discord.gg/PkDre8Juhp) with any proof if possible."
                            ),
                            color=0x87CEEB
                        )
            ...
            if len(self.guild_command_tracking[guild_id]) > 8:
                ...
                embed = discord.Embed(
                    ...
                    description=(
                        ...
                        f"If you believe this is a mistake, please contact our [Support Server](https://discord.gg/PkDre8Juhp)."
                    ),
                    color=0x87CEEB
                )
        ...
        if retry:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                if message.content in (f'<@{self.bot_user_id}>', f'<@!{self.bot_user_id}>'):
                    ...
                    embed = discord.Embed(
                        title="<:zwarning:1448949627712966717> User Blacklisted",
                        description=f"**{message.author.mention} has been blacklisted for repeatedly mentioning me. If you believe this is a mistake, please contact our [Support Server](https://discord.gg/PkDre8Juhp) with any proof if possible.**",
                        color=0x87CEEB
                    )
                    await message.channel.send(embed=embed)
                    return
    ...
    async def on_command(self, ctx):
        ...
        if retry:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                embed = discord.Embed(
                    title="<:zwarning:1448949627712966717> User Blacklisted",
                    description=f"**{ctx.author.mention} has been blacklisted for spamming commands. If you believe this is a mistake, please contact our [Support Server](https://discord.gg/PkDre8Juhp) with any proof if possible.**",
                    color=0x87CEEB
                )
